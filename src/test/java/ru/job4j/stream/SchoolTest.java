...
public class SchoolTest {
    ...
    public void whenCollectClassA() {
        ...
        Predicate<Student> pr = predicate -> predicate.getScore() >= 70;
    ...
    public void whenCollectClassB() {
        School sc = new School();
        Predicate<Student> pr1 = predicate -> predicate.getScore() >= 50;
        Predicate<Student> pr2 = predicate -> predicate.getScore() < 70;
    ...
    public void whenCollectClassC() {
        School sc = new School();
        Predicate<Student> pr = predicate -> predicate.getScore() < 50;
        List<Student> rsl = sc.collect(students, pr);
        List<Student> expected = new ArrayList<>();
